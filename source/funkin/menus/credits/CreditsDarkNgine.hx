...
class CreditsDarkNgine extends funkin.options.TreeMenuScreen {
	public var error:Bool = false;
	public var totalContributions:Int = 0;
	public var contribFormats:Array<FlxTextFormatMarkerPair> = [];

	public function new() {
		super("DarkNgine", "credits.allContributors");
		tryUpdating(true);
	}
	...
	public function checkUpdate():Bool {
		...
		var idk = GitHub.getContributors(Flags.REPO_OWNER, Flags.REPO_NAME, function(e) {
			...
			funkin.backend.utils.NativeAPI.showMessageBox("DarkNgine Warning", errMsg, MSG_WARNING);
		});
		...
		Logs.verbose('[CreditsDarkNgine] Contributors list Updated!');
