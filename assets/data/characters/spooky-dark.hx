...
function postCreate() {
	if (PlayState.instance != null) {
		normalChar = new Character(0, 0, 'spooky', isPlayer);
		normalChar.alpha = 0;

		PlayState.instance.stage.applyCharStuff(normalChar, "dad", 0); // temporarily just locking this to the dad position
